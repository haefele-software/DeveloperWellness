...
│   ├── Ai/                              # FoundryAiInsightService (IChatClient over the model deployment, key auth), AiOptions, app-owned prompts
